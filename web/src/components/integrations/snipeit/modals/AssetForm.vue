        ...
        <q-step :name="3" title="Review" icon="create_new_folder" :done="step > 3">
          <q-list>
            <q-item dense>
              ...
              <q-item-section side top>{{ assetName }}</q-item-section>
            </q-item>
            <q-item dense>
              <q-item-section top>
                <q-item-label>Asset Tag</q-item-label>
              </q-item-section>
              <q-item-section side top>{{ assetTag }}</q-item-section>
            </q-item>
            <q-item dense>
              <q-item-section top>
                <q-item-label>Model</q-item-label>
              </q-item-section>
              <q-item-section side top>{{ assetModel.label }}</q-item-section>
            </q-item>
            <q-item dense>
              <q-item-section top>
                <q-item-label>Serial</q-item-label>
              </q-item-section>
              <q-item-section side top>{{ assetSerial }}</q-item-section>
            </q-item>
            <q-item dense>
              <q-item-section top>
                <q-item-label>Status</q-item-label>
              </q-item-section>
              <q-item-section side top>{{ assetStatus.label }}</q-item-section>
            </q-item>
            <q-item dense>
              <q-item-section top>
                <q-item-label>Company</q-item-label>
              </q-item-section>
              <q-item-section side top>{{ assetCompany.label }}</q-item-section>
            </q-item>
            <q-item dense>
              <q-item-section top>
                <q-item-label>Location</q-item-label>
              </q-item-section>
              <q-item-section side top>{{ assetLocation.label }}</q-item-section>
            </q-item>
            <q-item dense>
              <q-item-section top>
                <q-item-label>Manufacturer</q-item-label>
              </q-item-section>
              <q-item-section side top>{{ assetManufacturer.label }}</q-item-section>
            </q-item>
            <q-item dense>
              <q-item-section top>
                <q-item-label>Supplier</q-item-label>
              </q-item-section>
              <q-item-section side top>{{ assetSupplier.label }}</q-item-section>
            </q-item>
            <q-item dense>
              <q-item-section top>
                <q-item-label>Category</q-item-label>
              </q-item-section>
              <q-item-section side top>{{ assetCategory.label }}</q-item-section>
            </q-item>
            <q-item dense>
              <q-item-section top>
            ...
            <q-item dense>
              ...
              <q-item-section side top>{{ assetPurchaseDate }}</q-item-section>
            </q-item>
            <q-item dense>
              <q-item-section top>
                <q-item-label>Warranty (Months)</q-item-label>
              </q-item-section>
              <q-item-section side top>{{ assetWarrantyMonths }}</q-item-section>
            </q-item>
            <q-item dense>
              <q-item-section top>
                <q-item-label>Order Number</q-item-label>
              </q-item-section>
              <q-item-section side top>{{ assetOrderNumber }}</q-item-section>
            </q-item>
          </q-list>
        </q-step>
