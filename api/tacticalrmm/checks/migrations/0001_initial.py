    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shell', models.CharField(choices=[('powershell', 'Powershell'), ('batch', 'Batch'), ('python', 'Python')], default='powershell', max_length=100)),
            ],
        ),
        migrations.CreateModel(
            name='ScriptCheck',
            fields=[
                ...
                ('more_info', models.TextField(blank=True, null=True)),
                ('last_run', models.DateTimeField(auto_now=True)),
                ('agent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='scriptchecks', to='agents.Agent')),
