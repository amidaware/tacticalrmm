...
from scnplusrmm.util_settings import get_backend_url, get_root_domain, get_webdomain
...
LOG_DIR = os.path.join(BASE_DIR, "scnplusrmm/private/log")

EXE_DIR = os.path.join(BASE_DIR, "scnplusrmm/private/exe")
...
ASGI_APPLICATION = "scnplusrmm.asgi.application"
...
STATICFILES_DIRS = [os.path.join(BASE_DIR, "scnplusrmm/static/")]
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_AUTHENTICATION_CLASSES": (
        ...
        "scnplusrmm.auth.APIAuthentication",
    ),
...
SPECTACULAR_SETTINGS = {
    ...
    "AUTHENTICATION_WHITELIST": ["scnplusrmm.auth.APIAuthentication"],
}
...
CACHES = {
    "default": {
        "BACKEND": "scnplusrmm.cache.SCNPlusRedisCache",
...
MIDDLEWARE = [
    ...
    "scnplusrmm.middleware.LogIPMiddleware",
    "django.middleware.common.CommonMiddleware",
    "django.middleware.csrf.CsrfViewMiddleware",
    "django.contrib.auth.middleware.AuthenticationMiddleware",
    "scnplusrmm.middleware.AuditMiddleware",
...
if DEMO:
    MIDDLEWARE += ("scnplusrmm.middleware.DemoMiddleware",)


ROOT_URLCONF = "scnplusrmm.urls"
...
WSGI_APPLICATION = "scnplusrmm.wsgi.application"
