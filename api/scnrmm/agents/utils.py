...
from scnrmm.constants import MeshAgentIdent
...
def get_agent_url(*, goarch: str, plat: str, token: str = "") -> str:
    ...
    return f"https://github.com/ahmetkarakayaoffical/scnrmmagent/releases/download/v{ver}/scnagent-v{ver}-{plat}-{goarch}.exe"
