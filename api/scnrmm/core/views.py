...
from scnrmm.constants import AuditActionType, PAStatus
from scnrmm.helpers import get_certs, notify_error
from scnrmm.logger import logger
from scnrmm.permissions import (
    _has_perm_on_agent,
    _has_perm_on_client,
    _has_perm_on_site,
)
...
def dashboard_info(request):
    ...
    from scnrmm.utils import get_latest_trmm_ver, runcmd_placeholder_text
...
def server_maintenance(request):
    from scnrmm.utils import reload_nats
...
class RunURLAction(APIView):
    ...
    def patch(self, request):
        ...
        from scnrmm.utils import RE_DB_VALUE, get_db_value
...
def status_v2(request):
    from agents.models import Agent
    from clients.models import Client, Site
    from scnrmm.helpers import get_nats_ports
    from scnrmm.utils import get_celery_queue_len, localhost_port_is_open
