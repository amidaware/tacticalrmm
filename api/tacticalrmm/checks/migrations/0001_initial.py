    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('check_type', models.CharField(choices=[('diskspace', 'Disk Space Check'), ('ping', 'Ping Check'), ('cpuload', 'CPU Load Check'), ('memory', 'Memory Check'), ('winsvc', 'Win Service Check'), ('script', 'Script Check'), ('eventlog', 'Event Log Check')], max_length=50)),
