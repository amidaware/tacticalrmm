...
# weekly
def test_should_run_weekly_correct_day_and_time(
    time_machine, run_time_10am, est_timezone
):
...
def test_should_not_run_monthly_incorrect_month(
    time_machine, run_time_10am, est_timezone
):
...
def test_should_run_monthly_last_day_of_month(
    time_machine, run_time_10am, est_timezone
):
...
def test_should_run_monthly_last_day_of_leap_year_february(
    time_machine, run_time_10am, est_timezone
):
...
# monthly dow
def test_should_run_monthly_dow_correct_week_and_day(
    time_machine, run_time_10am, est_timezone
):
...
def test_should_run_monthly_dow_last_week_of_month(
    time_machine, run_time_10am, est_timezone
):
...
def test_should_not_run_monthly_dow_incorrect_week(
    time_machine, run_time_10am, est_timezone
):
